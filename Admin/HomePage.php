...
<head>
    ...
    <link rel="stylesheet" href="../Assets/CSS/AdminHomeStyle.css">
     ...
     <div class="main_container">
        <div class="side_bar">
            <div class="side_bar_title">
                <div class="sidebar_logo">Logo</div>
                <div class="options">
                ...
                <div class="options">
                   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-journals" viewBox="0 0 16 16">
                    ...
                    <div style="margin-left:10px">Course</div>
                </div>
                <div class="options">
                   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16">
                    ...
                    <div style="margin-left:10px">Subject</div>
                </div>
                <div class="options">
                   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">
                    ...
                    <div style="margin-left:10px">Manage Notes</div>
                </div>
                 <div class="options">
                   <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                    ...
                    <div style="margin-left:10px">View Users</div>
                </div>
                 <div class="options">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
                    ...
                    <div style="margin-left:10px">Complaints</div>
                </div>
                <div class="options">
                ...
                <path d="m2.165 15.803.02-.004c1.83-.363 2.948-.842 3.468-1.105A9 9 0 0 0 8 15c4.418 0 8-3.134 8-7s-3.582-7-8-7-8 3.134-8 7c0 1.76.743 3.37 1.97 4.6a10.4 10.4 0 0 1-.524 2.318l-.003.011a11 11 0 0 1-.244.637c-.079.186.074.394.273.362a22 22 0 0 0 .693-.125m.8-3.108a1 1 0 0 0-.287-.801C1.618 10.83 1 9.468 1 8c0-3.192 3.004-6 7-6s7 2.808 7 6-3.004 6-7 6a8 8 0 0 1-2.088-.272 1 1 0 0 0-.711.074c-.387.196-1.24.57-2.634.893a11 11 0 0 0 .398-2"/>
                    ...
                    <div style="margin-left:10px">Feedbacks</div>
                </div>
                <div class="optionl">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                    ...
                    <div style="margin-left:10px">Logout</div>
                </div>
            </div>
        </div>
